...
docker run --rm -it --log-driver=none -a stdin -a stdout -a stderr -v /tmp/xxx/system-test:/system-test  hkube/jmeter:1.0.5 -c "cd /system-test/run_files; ./regression_indeviduals.sh" | tee ./out.log
